...
import { applyNumber, clearAction, memoryClearAction, totalToMemoryAction, operatorAction } from './actions';
...
function App() {
  ...
  const handleMemoryClear = () => {
    dispatch(memoryClearAction())
  }

  const handleMemoryToTotal = () => {
    dispatch(totalToMemoryAction())
  }
      ...
      <div className = "container row mt-5">
        <div className="col-md-12 d-flex justify-content-center">
          <form name="Cal">
            ...
            <div className="row">
              <CalcButton onClick={handleMemoryToTotal}value={"M+"}/>
              <CalcButton value={"MR"}/>
            ...
            <div className="row">
              <CalcButton onClick={()=>{handleOperatorChange('+')}}value={"+"}/>
              <CalcButton onClick={()=>{handleOperatorChange('*')}}value={"*"}/>
              <CalcButton onClick={()=>{handleOperatorChange('-')}}value={"-"}/>
            </div>

            <div className="row ce_button">
              <CalcButton onClick={handleClearChange} value={"CE"}/>
            </div>
